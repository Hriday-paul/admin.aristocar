...
export default function ProfileContainer() {
  ...
  return (
    ...
    >
      <div className="w-full px-5 mx-auto text-white lg:w-3/4 lg:px-0 2xl:w-1/2">
        {/* Profile pic */}
        <section className="flex-center gap-x-3">
          <div className="relative w-max">
            <Image
              ...
              width={1200}
              height={1200}
              className="aspect-square h-auto w-[160px] rounded-full border-2 border-green-400 p-1"
            />
